...
def update_existing_picking_type(cr, registry):
    ...
    subtype_id = obj_data.get_object_reference(
        cr, SUPERUSER_ID, "stock_operation_subtype", "good_receipt_subtype")[1]
    ...
    subtype_id = obj_data.get_object_reference(
        cr, SUPERUSER_ID, "stock_operation_subtype",
        "internal_transfer_subtype")[1]

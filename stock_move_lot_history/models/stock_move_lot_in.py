...
class StockMoveLotIn(models.Model):
    _name = "stock.stock_move_lot_in"
    _description = "Stock Move Lot In"
    _auto = False
    ...
    def init(self, cr):
        drop_view_if_exists(cr, "stock_stock_move_lot_in")
        strSQL = """
                    CREATE OR REPLACE VIEW stock_stock_move_lot_in AS (
                        SELECT
